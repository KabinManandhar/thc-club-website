-- Seed initial data for THC Club (with conflict handling)

-- Clear existing shelf slots if needed and insert fresh data
...
-- Insert sample admin user (with conflict handling)
INSERT INTO admin_users (email, name, role) VALUES
('admin@thcclub.com', 'THC Club Admin', 'super_admin')
ON CONFLICT (email) DO NOTHING;

-- Insert some sample waitlist entries (with conflict handling)
